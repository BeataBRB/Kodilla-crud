...
public class TrelloMapperTestSuite {
    ...
    public void mapToBoardsTest() {
        ...
        TrelloBoradDto trelloBoardDto = new TrelloBoradDto("testBoard", "1", listDto);
        List<TrelloBoradDto> boardDto = Arrays.asList(trelloBoardDto);
    ...
    public void mapToBoardsDtoTest() {
        ...
        //When
        List<TrelloBoradDto> mappedList = trelloMapper.mapToBoardsDto(board);
